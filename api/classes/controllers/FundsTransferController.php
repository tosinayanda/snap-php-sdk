...
use myApp\Validator;
use myApp\FundsTransferRepository;

final class FundsTransferController
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->applicationname="FUNDS.TRANSFER";
        $this->databaseconnection=$dbc;  
        $this->repo=new FundsTransferRepository();   
       // var_dump($dbc);
    }
    public function All (Request $request, Response $response, array $args)
    {
        ...
        $newResponse= $response->withStatus(200)->withJson($customers);
